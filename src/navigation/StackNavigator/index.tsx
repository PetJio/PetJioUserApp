...
import NewPasswordScreen from '../../screens/ForgetPassword/NewPasswordScreen';
import OTPVerificationScreen from '../../screens/ForgetPassword/OTPVerificationScreen';
...
const StackNavigator: React.FC<StackNavigatorProps> = ({
  ...
  return (
    ...
    >
      ...
      <Stack.Screen
        name="Paymentconfirmmethod"
        component={Paymentconfirmmethod}
      />
      ...
      <Stack.Screen
        name="TrainingLocalAddress"
        component={TrainingLocalAddress}
      />
      ...
      <Stack.Screen
        name="TrainingConfirmDetails"
        component={TrainingConfirmDetails}
      />
      <Stack.Screen
        name="TrainingPaymentmethod"
        component={TrainingPaymentmethod}
      />
      <Stack.Screen
        name="TrainingPaymentconfirmmethod"
        component={TrainingPaymentconfirmmethod}
      />
      ...
      <Stack.Screen
        name="BoardingRegistrationform"
        component={BoardingRegistrationform}
      />
      ...
      <Stack.Screen
        name="BoardingPaymentmethod"
        component={BoardingPaymentmethod}
      />
      ...
      <Stack.Screen
        ...
        component={DonatePaymentMethod}
      />
      <Stack.Screen
        name="DonatePaymentconfirmmethod"
        component={DonatePaymentconfirmmethod}
      />
      <Stack.Screen
        name="DogAdoptionScreeningForm"
        component={DogAdoptionScreeningForm}
      />
      <Stack.Screen
        name="VirtualAdoptionDetails"
        component={VirtualAdoptionDetails}
      />
      <Stack.Screen name="ParavetServices" component={ParavetServices} />
      <Stack.Screen name="ParaVetCheckout" component={ParaVetCheckout} />
      <Stack.Screen
        name="ParaVetPaymentmethod"
        component={ParaVetPaymentmethod}
      />
      <Stack.Screen name="ParaVetGoogleMap" component={ParaVetGoogleMap} />
      <Stack.Screen name="GroomingDetails" component={GroomingDetails} />
      <Stack.Screen
        name="GroomingPaymentmethod"
        component={GroomingPaymentmethod}
      />
      <Stack.Screen
        name="MartLocalityAddress"
        component={MartLocalityAddress}
      />
      <Stack.Screen name="PetjioMartStore" component={PetjioMartStore} />
      <Stack.Screen name="AllCategories" component={AllCategories} />
      <Stack.Screen
        name="PetProductDescription"
        component={PetProductDescription}
      />
      <Stack.Screen name="WishlistProduct" component={WishlistProduct} />
      <Stack.Screen name="MyCart" component={MyCart} />
      <Stack.Screen name="CheckOut" component={CheckOut} />
      <Stack.Screen
        name="PetMartPaymentMethod"
        component={PetMartPaymentMethod}
      />
      <Stack.Screen
        name="PetMartPaymentconfirmmethod"
        component={PetMartPaymentconfirmmethod}
      />
      <Stack.Screen
        name="GroomingPaymentconfirmmethod"
        component={GroomingPaymentconfirmmethod}
      />
      <Stack.Screen
        name="ParaVetPaymentconfirmmethod"
        component={ParaVetPaymentconfirmmethod}
      />
      ...
      <Stack.Screen
        name="VoiceCallWithVeterinary"
        component={VoiceCallWithVeterinary}
      />
      <Stack.Screen
        name="OnlineChatWithVeterinary"
        component={OnlineChatWithVeterinary}
      />
      <Stack.Screen name="ChatList" component={ChatList} />
      <Stack.Screen name="Chat" component={Chat} />
      <Stack.Screen
        name="LiveTalkToVeterinary"
        component={LiveTalkToVeterinary}
      />
      <Stack.Screen
        name="PharmacyOrderOverview"
        component={PharmacyOrderOverview}
      />
      <Stack.Screen
        name="VeterinaryPaymentMethod"
        component={VeterinaryPaymentMethod}
      />
      <Stack.Screen
        name="PharmacyOrderOnTheWay"
        component={PharmacyOrderOnTheWay}
      />
      <Stack.Screen
        name="VeterinaryHomeVisiteDetails"
        component={VeterinaryHomeVisiteDetails}
      />
