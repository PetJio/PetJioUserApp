...
import veterinarypetcoinmodalstyles from './veterinarypetcoinmodal.styles';
...
const VeterinaryPetcoinModal: React.FC<Omit<ModalComponentProps, 'navigation'>> = ({modalVisible,setModalVisible}) => {
...
const radioButtons = useMemo(() => ([
  ...
  },
  {
    ...
    return (
        <View style={veterinarypetcoinmodalstyles.container}>
            <Modal
                animationType="slide"
                transparent={true}
                visible={modalVisible}
                onRequestClose={() => setModalVisible(false)}>
                <View style={veterinarypetcoinmodalstyles.subcontainer}>
                    <View style={veterinarypetcoinmodalstyles.modalRadiousView}>
                         <View style={veterinarypetcoinmodalstyles.GapView}>
                               ...
                               {/* <RadioGroup
                                 ...
                                 layout="row"
                                 containerStyle={veterinarypetcoinmodalstyles.radioContainer}
                           /> */}
                        ...
                        <View style={veterinarypetcoinmodalstyles.fixedButtonContainer}>
                            <TouchableOpacity
                                 onPress={()=>navigation.navigate("PharmacyOrderOnTheWay")}
                                style={veterinarypetcoinmodalstyles.nextBtnContainer}>
                                <Text style={veterinarypetcoinmodalstyles.nextBtnText}>
                                    Confirm
                                </Text>
                            </TouchableOpacity>
                        </View>
...
export default VeterinaryPetcoinModal;