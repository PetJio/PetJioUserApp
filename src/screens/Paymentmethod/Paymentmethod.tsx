...
import WalkingPetcoinModal from '../WalkingPetcoinModal/WalkingPetcoinModal';
...
type RootStackParamList = {
      ...
      // Define once
      type PaymentmethodRouteProp = RouteProp<RootStackParamList, 'Paymentconfirmmethod'>;
      
      type ConfirmPaymentScreenNavigationProp = StackNavigationProp<RootStackParamList,'Paymentconfirmmethod'>;
 ...
 const Paymentmethod: React.FC<ConfirmPaymenProps> = ({navigation}) => {
    ...
    return (
        <View style={paymentmethodstyles.container}>
             <View style={paymentmethodstyles.containerchild}>
                    <TouchableOpacity onPress={()=>handleTabWithNavigation()}>
                        <View style={paymentmethodstyles.containerfirstsubchild}>
                            <Image
                                source={Icons.LeftArrow}
                                style={paymentmethodstyles.leftarrowicon}
                            />
                            <Text style={paymentmethodstyles.checkoutText}>
                ...
                <View style={{gap:responsiveHeight(2.4),top:responsiveHeight(4)}}>
                       ...
                       <TouchableOpacity onPress={()=>navigation.navigate('Paymentconfirmmethod', { section: 'Google Pay UPI' })}>
                       ...
                       <TouchableOpacity onPress={()=>navigation.navigate('Paymentconfirmmethod', { section: 'Google Pay UPI' })}>
                        ...
                        <WalkingPetcoinModal modalVisible={modalVisible} setModalVisible={setModalVisible}/>
                         <TouchableOpacity
