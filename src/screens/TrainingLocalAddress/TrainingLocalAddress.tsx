...
import trainingaddressstyles from './TrainingLocalAddress.styles';
...
type RootStackParamList = {
    ...
    TrainingAddress: { section: string };
    Grooming:undefined;
    Walking:undefined;
    Training:undefined;
...
type TrainingLocalAddressScreenNavigationProp = StackNavigationProp<RootStackParamList, 'TrainingAddress'>;
type TrainingLocalAddressScreenRouteProp = RouteProp<RootStackParamList, 'TrainingAddress'>;


// Define props interface for the component
interface TrainingLocalAddressProps {
  navigation:TrainingLocalAddressScreenNavigationProp;
  route: TrainingLocalAddressScreenRouteProp;
}

const TrainingLocalAddress: React.FC<TrainingLocalAddressProps> = ({navigation,route }) => {
    ...
    return (
        ...
        <View style={trainingaddressstyles.searchparent}>
                <View style={trainingaddressstyles.searchchild}>
                   
                   <Image source={Icons.search} style={{marginLeft:responsiveHeight(1.5)}}/>

                    <TextInput
                        placeholder="Search for services"
                        placeholderTextColor="#999"
                        style={trainingaddressstyles.textInput}
                    />
                </View>
...
export default TrainingLocalAddress;
