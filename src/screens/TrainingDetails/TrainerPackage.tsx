...
import trainerpackagestyles from './trainerpackage.styles';
...
const TrainerPackage: React.FC<WalkingPackageProps> = ({navigation}) => {
  const [isChecked, setIsChecked] = useState<boolean>(false);
  const [modalVisible, setModalVisible] = useState<boolean>(false);

  return (
          <View style={trainerpackagestyles.container}>
            ...
            {/* <ModalComponent modalVisible = {modalVisible} setModalVisible={setModalVisible}/> */}
              <View style={trainerpackagestyles.fixedButtonContainer}>
                      <TouchableOpacity
                        onPress={() => setModalVisible(true)}
                          style={trainerpackagestyles.nextBtnContainer}>
                          <Text style={trainerpackagestyles.nextBtnText}>Book Now at ₹200 per walk</Text>
                      </TouchableOpacity>
              </View>
