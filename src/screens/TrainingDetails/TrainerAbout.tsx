...
import traineraboutstyles from './trainerabout.styles';
...
const TrainerAbout: React.FC = () => {
            ...
            (dot: { id: string; name: string; image: any }, index: number) => {
                if (activeIndex === index) {
                    return (
                        <View
                            key={index}
                            style={traineraboutstyles.green_dot_Indicator}
                        />
                    );
                } else {
                    return (
                        <View
                            key={index}
                            style={traineraboutstyles.white_dot_Indicator}
                        />
                    );
                }
            },
    ...
    return (
         ...
         >
             ...
             <View
        style={traineraboutstyles.container}>
        <View>
            <Text style={traineraboutstyles.bioText}>Bio</Text>
            <Text style={traineraboutstyles.paragraphText}>
        ...
        <View style={traineraboutstyles.languageJobText}>
            <View>
                <Text
                    style={{
                        fontSize: 14,
        ...
        <View style={traineraboutstyles.expertiseText}>
            <View
                style={{
                    flexDirection: 'row',
            ...
            <View style={traineraboutstyles.setGap}>
                <View style={traineraboutstyles.DigitBorder}>
                    <Text
                        style={{
                            fontSize: 10,
                            fontWeight: '500',
                ...
                <View style={traineraboutstyles.selectedDate}>
                    <Text
                        style={{
                            fontSize: 10,
                            fontWeight: '500',
        ...
        <View style={traineraboutstyles.dotPosition}>
            <FlatList
                data={Carousel}
                ref={flatListRef}
            ...
            />
            <View style={traineraboutstyles.bottomparentview}>
                {/* Dots Indicator */}
                <View style={traineraboutstyles.dots_Indicator}>
                    {renderDotIndicators()}
                </View>
            </View>
        </View>
