...
const BoardingReview: React.FC<BoardingReviewProps> = ({ rating = 4.8, reviews = 150 }) => {
...
<View style={boardingreviewstyles.contentGap}>
    ...
    >
        {Array(reviews > 10 ? 10 : reviews).fill(null).map((_, index) => (
            <View key={index} style={boardingreviewstyles.generatedViewGap}>
              ...
              <View style={boardingreviewstyles.imageTextGap}>
                    <View>
                        ...
                        />
                        <Text style={boardingreviewstyles.ratingSize}>{rating}</Text>
                    </View>
                    <View>
