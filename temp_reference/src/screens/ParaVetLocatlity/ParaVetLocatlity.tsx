...
import paravetlocatlity from './paravetlocatlity.styles';
...
type LocalityScreenNavigationProp = StackNavigationProp<RootStackParamList, 'ParaVetLocatlity'>;
type LocalityScreenRouteProp = RouteProp<RootStackParamList, 'ParaVetLocatlity'>;
...
const ParaVetLocatlity: React.FC<LocalityProps> = ({navigation,route }) => {
    ...
    return (
        ...
        <View style={paravetlocatlity.searchparent}>
                <View style={paravetlocatlity.searchchild}>
                    <Icon name="search" size={20} color="#4494A8" style={{marginLeft:responsiveHeight(1.5)}} />
                    <TextInput
                        placeholder="Search for services"
                        placeholderTextColor="#999"
                        style={paravetlocatlity.textInput}
                    />
                </View>
