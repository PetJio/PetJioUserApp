...
import boardingpetcoinmodalstyles from './boardingpetcoinmodal.styles';
...
const BoardingPetcoinModal: React.FC<Omit<ModalComponentProps, 'navigation'>> = ({modalVisible,setModalVisible}) => {
...
const radioButtons = useMemo(() => ([
  ...
  },
  {
    ...
    return (
        <View style={boardingpetcoinmodalstyles.container}>
            <Modal
                animationType="slide"
                transparent={true}
                visible={modalVisible}
                onRequestClose={() => setModalVisible(false)}>
                <View style={boardingpetcoinmodalstyles.subcontainer}>
                    <View style={boardingpetcoinmodalstyles.modalRadiousView}>
                         <View style={boardingpetcoinmodalstyles.GapView}>
                               ...
                               {/* <RadioGroup
                                 ...
                                 layout="row"
                                 containerStyle={boardingpetcoinmodalstyles.radioContainer}
                           /> */}
                        ...
                        <View style={boardingpetcoinmodalstyles.fixedButtonContainer}>
                            <TouchableOpacity
                                 onPress={()=>navigation.navigate("BoardingBooking")}
                                style={boardingpetcoinmodalstyles.nextBtnContainer}>
                                <Text style={boardingpetcoinmodalstyles.nextBtnText}>
                                    Confirm
                                </Text>
                            </TouchableOpacity>
                        </View>
...
export default BoardingPetcoinModal;