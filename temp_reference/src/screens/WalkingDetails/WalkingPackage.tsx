...
import walkingpackagestyles from './WalkingPackage.styles';
...
const WalkingPackage: React.FC<WalkingPackageProps> = ({navigation}) => {
  const [isChecked, setIsChecked] = useState<boolean>(false);
  const [modalVisible, setModalVisible] = useState<boolean>(false);

  return (
          <View style={walkingpackagestyles.container}>
            ...
            <View style={{position: 'relative' }}>
              ...
              <View style={{width: responsiveWidth(80), paddingHorizontal: responsiveWidth(8),  position: 'absolute', top: responsiveHeight(12.8) }}>
                <Text style={{fontSize:12,lineHeight:12,fontWeight:'600',letterSpacing:0,color:'#FFFFFF'}}>What’s Included?</Text>
                  <View style={{width:responsiveWidth(80), flexDirection:'row',gap:responsiveWidth(4)}}>
                  <View style={{gap:responsiveHeight(0.90),top:responsiveHeight(0.90)}}>
                    ...
                    <Image source={images.petdogImage} style={{ width:responsiveWidth(70),height:responsiveHeight(20),resizeMode:'contain',bottom:responsiveHeight(2),right:responsiveWidth(36),transform: [{ rotate: '-180deg' },{ scaleY: -1 }]}}/>
                  </View>
              </View>
            </View>
            <View style={{ position: 'relative' }}>
              ...
              <View style={{width: responsiveWidth(100), paddingHorizontal: responsiveWidth(8),  position: 'absolute', top: responsiveHeight(12.8) }}>
                <Text style={{fontSize:12,lineHeight:12,fontWeight:'600',letterSpacing:0,color:'#FFFFFF'}}>What’s Included?</Text>
                  ...
                  <View style={{gap:responsiveHeight(0.90),top:responsiveHeight(0.90)}}>
                    ...
                    <Image source={images.adulttrainingImage} style={{ width:responsiveWidth(80),height:responsiveHeight(25),resizeMode:'contain',bottom:responsiveHeight(9),right:responsiveWidth(20)}}/>
                  </View>
              </View>
            </View>
              ...
              <View style={{width: responsiveWidth(100), paddingHorizontal: responsiveWidth(8),  position: 'absolute', top: responsiveHeight(12.8) }}>
                <Text style={{fontSize:12,lineHeight:12,fontWeight:'600',letterSpacing:0,color:'#FFFFFF'}}>What’s Included?</Text>
                  ...
                  <View style={{gap:responsiveHeight(0.90),top:responsiveHeight(0.90)}}>
                    ...
                    <Image source={images.packageImage} style={{ width:responsiveWidth(80),height:responsiveHeight(25),resizeMode:'contain',bottom:responsiveHeight(9),right:responsiveWidth(20)}}/>
                  </View>
              </View>
            </View>
            ...
            <ModalComponent modalVisible = {modalVisible} setModalVisible={setModalVisible} />
              <View style={walkingpackagestyles.fixedButtonContainer}>
                      <TouchableOpacity
                        onPress={() => setModalVisible(true)}
                          style={walkingpackagestyles.nextBtnContainer}>
                          <Text style={walkingpackagestyles.nextBtnText}>Book Now at ₹200 per walk</Text>
                      </TouchableOpacity>
              </View>
