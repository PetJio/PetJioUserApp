...
import walkingaboutstyles from './WalkingAbout.styles';

const WalkingAbout: React.FC = () => {
            ...
            (dot: { id: string; name: string; image: any }, index: number) => {
                if (activeIndex === index) {
                    return (
                        <View
                            key={index}
                            style={walkingaboutstyles.green_dot_Indicator}
                        />
                    );
                } else {
                    return (
                        <View
                            key={index}
                            style={walkingaboutstyles.white_dot_Indicator}
                        />
                    );
                }
            },
    ...
    return (
          ...
          contentContainerStyle={{paddingBottom:responsiveWidth(30)}}
          >

            <View
        style={walkingaboutstyles.container}>
        <View>
            <Text style={walkingaboutstyles.bioText}>Bio</Text>
            <Text style={walkingaboutstyles.paragraphText}>
        ...
        <View style={walkingaboutstyles.languageJobText}>
            <View>
                <Text
                    style={{
                        fontSize: 14,
        ...
        <View style={walkingaboutstyles.expertiseText}>
            <View
                style={{
                    flexDirection: 'row',
            ...
            <View style={walkingaboutstyles.setGap}>
                <View style={walkingaboutstyles.DigitBorder}>
                    <Text
                        style={{
                            fontSize: 10,
                            fontWeight: '500',
                ...
                <View style={walkingaboutstyles.selectedDate}>
                    <Text
                        style={{
                            fontSize: 10,
                            fontWeight: '500',
        ...
        <View style={walkingaboutstyles.dotPosition}>
            <FlatList
                data={Carousel}
                ref={flatListRef}
            ...
            />
            <View style={walkingaboutstyles.bottomparentview}>
                {/* Dots Indicator */}
                <View style={walkingaboutstyles.dots_Indicator}>
                    {renderDotIndicators()}
                </View>
            </View>
        </View>
