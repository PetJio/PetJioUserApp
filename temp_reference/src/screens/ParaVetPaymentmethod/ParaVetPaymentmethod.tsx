...
import ParavetPetcoinModal from '../ParavetPetcoinModal/ParavetPetcoinModal';
import paravetpaymentmethodstyles from './paravetpaymentmethod.styles';
...
type RootStackParamList = {
        ...
        ParaVetGoogleMap:{ section: string };
      };
 ...
 const ParaVetPaymentmethod: React.FC<ConfirmPaymenProps> = ({navigation}) => {
        const [modalVisible,setModalVisible] = useState<boolean>(false);
        const route = useRoute<PaymentmethodRouteProp>();
    return (
        <View style={paravetpaymentmethodstyles.container}>
             <View style={paravetpaymentmethodstyles.containerchild}>
                    <TouchableOpacity onPress={()=>navigation.navigate("ParaVetCheckout")}>
                        <View style={paravetpaymentmethodstyles.containerfirstsubchild}>
                            <Image
                                source={Icons.LeftArrow}
                                style={paravetpaymentmethodstyles.leftarrowicon}
                            />
                            <Text style={paravetpaymentmethodstyles.checkoutText}>
                ...
                <View style={{gap:responsiveHeight(2.4),top:responsiveHeight(4)}}>
                       ...
                       <TouchableOpacity onPress={()=>navigation.navigate('TrainingPaymentconfirmmethod', { section: 'Google Pay UPI' })}>
                        ...
                        <TouchableOpacity onPress={()=>navigation.navigate('ParaVetGoogleMap', { section: 'Google Pay UPI' })}>
                        <View style={{flexDirection:'row',justifyContent:'space-between',paddingHorizontal:responsiveWidth(6)}}>
                            <View style={{flexDirection:'row',gap:responsiveWidth(2)}}>
                                <View style={{width:responsiveWidth(15),height:responsiveHeight(4.5),borderWidth:responsiveWidth(0.30),borderRadius:responsiveWidth(1),borderColor:'#EBEBEB',justifyContent:'center',alignItems:'center'}}>
                       ...
                       <TouchableOpacity onPress={()=>navigation.navigate('TrainingPaymentconfirmmethod', { section: 'Google Pay UPI' })}>
                        ...
                        <ParavetPetcoinModal modalVisible={modalVisible} setModalVisible={setModalVisible}/>
...
export default ParaVetPaymentmethod;
