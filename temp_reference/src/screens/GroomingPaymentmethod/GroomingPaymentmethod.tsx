...
import groomingpaymentmethodstyles from './groomingpaymentmethod.styles';
import {responsiveHeight, responsiveWidth } from 'react-native-responsive-dimensions';
import { StackNavigationProp } from '@react-navigation/stack';
import { useRoute, RouteProp } from '@react-navigation/native';
import GroomingPetcoinModal from '../GroomingPetcoinModal/GroomingPetcoinModal';
...
type RootStackParamList = {
      ...
      // Define once
      type PaymentmethodRouteProp = RouteProp<RootStackParamList, 'TrainingPaymentconfirmmethod'>;
      
      type ConfirmPaymentScreenNavigationProp = StackNavigationProp<RootStackParamList,'TrainingPaymentconfirmmethod'>;
 ...
 const GroomingPaymentmethod: React.FC<ConfirmPaymenProps> = ({navigation}) => {

  const [modalVisible,setModalVisible] = useState<boolean>(false);
       
    return (
        <View style={groomingpaymentmethodstyles.container}>
             <View style={groomingpaymentmethodstyles.containerchild}>
                    <TouchableOpacity onPress={()=>navigation.navigate("ServicePrice")}>
                        <View style={groomingpaymentmethodstyles.containerfirstsubchild}>
                            <Image
                                source={Icons.LeftArrow}
                                style={groomingpaymentmethodstyles.leftarrowicon}
                            />
                            <Text style={groomingpaymentmethodstyles.checkoutText}>
                ...
                <View style={{gap:responsiveHeight(2.4),top:responsiveHeight(4)}}>
                       ...
                       <TouchableOpacity onPress={()=>navigation.navigate('GroomingPaymentconfirmmethod')}>
                       ...
                       <TouchableOpacity onPress={()=>navigation.navigate('GroomingPaymentconfirmmethod')}>
                        ...
                        <GroomingPetcoinModal modalVisible={modalVisible} setModalVisible={setModalVisible}  />
                        <View style={{width:responsiveWidth(100),borderWidth:responsiveWidth(0.20),borderColor:'#ECECEC'}}/>
                        <View style={{paddingHorizontal:responsiveWidth(6.5)}}>
                       ...
                       <TouchableOpacity
                        ...
                        >
                           <View style={{flexDirection:'row',justifyContent:'space-between',paddingHorizontal:responsiveWidth(6)}}>
                            <View style={{flexDirection:'row',gap:responsiveWidth(2)}}>
                            <View style={{width:responsiveWidth(15),height:responsiveHeight(4.5),borderWidth:responsiveWidth(0.30),borderRadius:responsiveWidth(1),borderColor:'#EBEBEB',justifyContent:'center',alignItems:'center'}}>
                                    <Image source={Icons.petcoinIcon} style={{width:responsiveWidth(8),height:responsiveHeight(4)}}  />
                            </View>
                                <View style={{justifyContent:'center',alignItems:'center'}}>
...
export default GroomingPaymentmethod;
