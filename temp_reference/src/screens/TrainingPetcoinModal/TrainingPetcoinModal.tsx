...
import trainingpetcoinmodalstyles from './trainingpetcoinmodal.styles';
...
const TrainingPetcoinModal: React.FC<Omit<ModalComponentProps, 'navigation'>> = ({modalVisible,setModalVisible}) => {
...
const radioButtons = useMemo(() => ([
  ...
  },
  {
    ...
    return (
        <View style={trainingpetcoinmodalstyles.container}>
            <Modal
                animationType="slide"
                transparent={true}
                visible={modalVisible}
                onRequestClose={() => setModalVisible(false)}>
                <View style={trainingpetcoinmodalstyles.subcontainer}>
                    <View style={trainingpetcoinmodalstyles.modalRadiousView}>
                         <View style={trainingpetcoinmodalstyles.GapView}>
                               ...
                               {/* <RadioGroup
                                 ...
                                 layout="row"
                                 containerStyle={trainingpetcoinmodalstyles.radioContainer}
                           /> */}
                        ...
                        <View style={trainingpetcoinmodalstyles.fixedButtonContainer}>
                            <TouchableOpacity
                                 onPress={()=>navigation.navigate("TrainingPaymentconfirmmethod")}
                                style={trainingpetcoinmodalstyles.nextBtnContainer}>
                                <Text style={trainingpetcoinmodalstyles.nextBtnText}>
                                    Confirm
                                </Text>
                            </TouchableOpacity>
                        </View>
...
export default TrainingPetcoinModal;