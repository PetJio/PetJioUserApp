...
import martlocalityaddressstyles from './martlocalityaddress.styles';
...
const MartLocalityAddress: React.FC<LocalityProps> = ({navigation}) => {
    ...
    return (
        ...
        <View style={martlocalityaddressstyles.searchparent}>
                <View style={martlocalityaddressstyles.searchchild}>
                    <Icon name="search" size={20} color="#4494A8" style={{marginLeft:responsiveHeight(1.5)}} />
                    <TextInput
                        placeholder="Search for services"
                        placeholderTextColor="#999"
                        style={martlocalityaddressstyles.textInput}
                    />
                </View>
...
export default MartLocalityAddress;
