...
import petmartpaymentmethodstyles from './petmartpaymentmethod.styles';
...
type RootStackParamList = {
 ...
 const PetMartPaymentMethod: React.FC<ConfirmPaymenProps> = ({navigation}) => {
    ...
    return (
        <View style={petmartpaymentmethodstyles.container}>
             <View style={petmartpaymentmethodstyles.containerchild}>
                    <TouchableOpacity 
                        //  onPress={()=>handleTabWithNavigation()}
                        >
                        <View style={petmartpaymentmethodstyles.containerfirstsubchild}>
                            <Image
                                source={Icons.LeftArrow}
                                style={petmartpaymentmethodstyles.leftarrowicon}
                            />
                            <Text style={petmartpaymentmethodstyles.checkoutText}>
                ...
                <View style={{gap:responsiveHeight(2.4),top:responsiveHeight(4)}}>
                       ...
                       <TouchableOpacity onPress={()=>navigation.navigate('PetMartPaymentconfirmmethod',)}>
                       ...
                       <TouchableOpacity onPress={()=>navigation.navigate('PetMartPaymentconfirmmethod')}>
                        ...
                        <View style={{flexDirection:'row',justifyContent:'space-between',paddingHorizontal:responsiveWidth(6)}}>
                            ...
                            <View style={{width:responsiveWidth(15),height:responsiveHeight(4.5),borderWidth:responsiveWidth(0.30),borderRadius:responsiveWidth(1),borderColor:'#EBEBEB',justifyContent:'center',alignItems:'center'}}>
                                ...
                                <View style={{justifyContent:'center',alignItems:'center'}}>
                                        <Text  style={{fontSize:14,fontWeight:'600',color:'#000000',lineHeight:17}}>Petjio Money</Text>
                                        <Text style={{fontSize:10,fontWeight:'400',lineHeight:12,letterSpacing:0,color:'#5E5E5E'}}>Balance: ₹3 0</Text>
                                </View>
                        </View>
                            <Image source={Icons.IoIosArrowForward}/>
                        </View>
...
export default PetMartPaymentMethod;
