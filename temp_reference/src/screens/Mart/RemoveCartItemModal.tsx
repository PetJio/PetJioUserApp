...
import removecartitemmodalstyles from './removecartitemmodal.styles';
...
const RemoveCartItemModal: React.FC<Omit<ModalComponentProps, 'navigation'>> = ({modalVisible,setModalVisible}) => {
    ...
    return (
        <View style={removecartitemmodalstyles.container}>
            <Modal
                animationType="slide"
                transparent={true}
                visible={modalVisible}
                onRequestClose={() => setModalVisible(false)}>
                <View style={removecartitemmodalstyles.subcontainer}>
                    <View style={removecartitemmodalstyles.setmodalRadious}>
                      <View style={{gap:responsiveHeight(2)}}>
                        ...
                        <View style={removecartitemmodalstyles.fixedButtonContainer}>
                            <TouchableOpacity
                                 onPress={()=>setModalVisible(false)}
                                style={removecartitemmodalstyles.nextBtnContainer}>
                                <Text style={removecartitemmodalstyles.nextBtnText}>
                                    Confirm
                                </Text>
                            </TouchableOpacity>
                        </View>
