...
import boardingpackagestyles from './boardingpackage.styles';
...
const BoardingPackage: React.FC<WalkingPackageProps> = ({navigation}) => {
  const [isChecked, setIsChecked] = useState<boolean>(false);
  const [modalVisible, setModalVisible] = useState<boolean>(false);

  return (
          <View style={boardingpackagestyles.container}>
              ...
              <View style={boardingpackagestyles.fixedButtonContainer}>
                      <TouchableOpacity
                        onPress={() => setModalVisible(true)}
                          style={boardingpackagestyles.nextBtnContainer}>
                          <Text style={boardingpackagestyles.nextBtnText}>Book Now at ₹200 per walk</Text>
                      </TouchableOpacity>
              </View>
