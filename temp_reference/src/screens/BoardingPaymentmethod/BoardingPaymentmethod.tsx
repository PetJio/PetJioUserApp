...
import boardingpaymentmethodstyles from './boardingpaymentmethod.styles';
import BoardingPetcoinModal from '../Boarding/BoardingPetcoinModal';
...
type RootStackParamList = {
      ...
      // Define once
      type PaymentmethodRouteProp = RouteProp<RootStackParamList, 'BoardingBooking'>;
      
      type ConfirmPaymentScreenNavigationProp = StackNavigationProp<RootStackParamList,'BoardingBooking'>;
 ...
 const BoardingPaymentmethod: React.FC<ConfirmPaymenProps> = ({navigation}) => {
  const [modalVisible,setModalVisible] = useState<boolean>(false);
        // const route = useRoute<PaymentmethodRouteProp>();
        // const { section } = route?.params;
        // const handleTabWithNavigation = () => {
        //         if (section === 'training') {
        //             navigation.navigate("BookBoarder");
        //         }
        //     };

    return (
        <View style={boardingpaymentmethodstyles.container}>
             <View style={boardingpaymentmethodstyles.containerchild}>
                    <TouchableOpacity onPress={()=> navigation.navigate("BookBoarder")}>
                        <View style={boardingpaymentmethodstyles.containerfirstsubchild}>
                            <Image
                                source={Icons.LeftArrow}
                                style={boardingpaymentmethodstyles.leftarrowicon}
                            />
                            <Text style={boardingpaymentmethodstyles.checkoutText}>
                ...
                <View style={{gap:responsiveHeight(2.4),top:responsiveHeight(4)}}>
                       ...
                       <TouchableOpacity onPress={()=>navigation.navigate('BoardingBooking')}>
                       ...
                       <TouchableOpacity onPress={()=>navigation.navigate('BoardingBooking')}>
                        ...
                        <BoardingPetcoinModal modalVisible={modalVisible} setModalVisible={setModalVisible}/>
                        <TouchableOpacity
...
export default BoardingPaymentmethod;
