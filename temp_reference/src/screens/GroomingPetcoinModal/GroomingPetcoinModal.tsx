...
import groomingpetcoinmodalstyles from './groomingpetcoinmodal.styles';
...
const GroomingPetcoinModal: React.FC<Omit<ModalComponentProps, 'navigation'>> = ({modalVisible,setModalVisible}) => {
...
const radioButtons = useMemo(() => ([
  ...
  },
  {
    ...
    return (
        <View style={groomingpetcoinmodalstyles.container}>
            <Modal
                animationType="slide"
                transparent={true}
                visible={modalVisible}
                onRequestClose={() => setModalVisible(false)}>
                <View style={groomingpetcoinmodalstyles.subcontainer}>
                    <View style={groomingpetcoinmodalstyles.modalRadiousView}>
                         <View style={groomingpetcoinmodalstyles.GapView}>
                               ...
                               {/* <RadioGroup
                                 ...
                                 layout="row"
                                 containerStyle={groomingpetcoinmodalstyles.radioContainer}
                           /> */}
                        ...
                        <View style={groomingpetcoinmodalstyles.fixedButtonContainer}>
                            <TouchableOpacity
                                 onPress={()=>navigation.navigate("GroomingPaymentconfirmmethod")}
                                style={groomingpetcoinmodalstyles.nextBtnContainer}>
                                <Text style={groomingpetcoinmodalstyles.nextBtnText}>
                                    Confirm
                                </Text>
                            </TouchableOpacity>
                        </View>
...
export default GroomingPetcoinModal;
