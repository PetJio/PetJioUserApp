...
import trainingpaymentmethodstyles from './trainingPaymentmethod.styles';
import TrainingPetcoinModal from '../TrainingPetcoinModal/TrainingPetcoinModal';
...
type RootStackParamList = {
 ...
 const TrainingPaymentmethod: React.FC<ConfirmPaymenProps> = ({navigation}) => {
    ...
    return (
        <View style={trainingpaymentmethodstyles.container}>
             <View style={trainingpaymentmethodstyles.containerchild}>
                    <TouchableOpacity onPress={()=>handleTabWithNavigation()}>
                        <View style={trainingpaymentmethodstyles.containerfirstsubchild}>
                            <Image
                                source={Icons.LeftArrow}
                                style={trainingpaymentmethodstyles.leftarrowicon}
                            />
                            <Text style={trainingpaymentmethodstyles.checkoutText}>
                ...
                <View style={{gap:responsiveHeight(2.4),top:responsiveHeight(4)}}>
                       ...
                       <TouchableOpacity onPress={()=>navigation.navigate('TrainingPaymentconfirmmethod', { section: 'Google Pay UPI' })}>
                        ...
                        <TrainingPetcoinModal modalVisible={modalVisible} setModalVisible={setModalVisible}/>
...
export default TrainingPaymentmethod;
